...
#@register.tag
#def render_edit_profile_form(parser, token):
    #args = token.split_contents()
    #tag, opts, kwargs = split_args(args)
    #prefix = kwargs.get('prefix', '')
    #opts = [EditProfileForm(prefix=prefix)]
    #kwargs['upload_files'] = True
    #kwargs['action_name'] = 'edit_profile'
    #return RenderFormNode(*opts,**kwargs)

#@register.tag
#def render_signin_profile_form(parser, token):
    #args = token.split_contents()
    #tag, opts, kwargs = split_args(args)
    #prefix = kwargs.get('prefix', '')
    #opts = [SignInForm(prefix=prefix)]
    #kwargs['action_name'] = 'signin'
    #return RenderFormNode(*opts,**kwargs)

#@register.tag
#def render_login_profile_form(parser, token):
    #args = token.split_contents()
    #tag, opts, kwargs = split_args(args)
    #prefix = kwargs.get('prefix', '')
    #opts = [LoginForm(prefix=prefix)]
    #kwargs['action_name'] = 'profile_login'
    #return RenderFormNode(*opts,**kwargs)

#@register.tag
#def render_password_forgotten_form(parser, token):
    #args = token.split_contents()
    #tag, opts, kwargs = split_args(args)
    #prefix = kwargs.get('prefix', '')
    #opts = [PasswordForgottenForm(prefix=prefix)]
    #kwargs['action_name'] = 'password_forgotten'
    #return RenderFormNode(*opts,**kwargs)

#@register.tag
#def render_change_password_form(parser, token):
    #args = token.split_contents()
    #tag, opts, kwargs = split_args(args)
    #prefix = kwargs.get('prefix', '')
    #opts = [ChangePasswordForm(prefix=prefix)]
    #kwargs['action_name'] = 'change_password'
    #return RenderFormNode(*opts,**kwargs)